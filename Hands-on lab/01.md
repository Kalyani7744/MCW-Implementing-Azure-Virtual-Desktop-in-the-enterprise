...
8.  When prompted, sign in with the following credentials.
- Username: **ADadmin**
...
3.  Complete the New User wizard with the following details and click **Next**.
...
4.  Enter Password as **Password.1!!** and confirm the password. 

    - Enable **user must change password at next logon**. Click **Next** and **Finish**.
